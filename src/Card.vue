...
<template>
    <div
        ...
        <slot name="body">
            <div
                class="flex-1 border border-stone-200 dark:border-stone-700"
                :class="{
                    'p-3': size === 'sm',
                    'p-4': size === 'md',
                    'p-6': size === 'lg',
        ...
        <div
            v-if="$slots.footer"
            class="flex items-center justify-end gap-4 border border-t-0 border-stone-200 px-6 py-4 text-sm dark:border-stone-700"
            :class="{
